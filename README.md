...
| Physical layer | The characteristics in physical layer that taken into account: <br> <ul><li>NVIDIA SionnaRT-based online channel</li> <li>Calibrated on-demand RT and analytical A2A channels</li> <li>Packet collisions and signal interference</li> <li>Unicast, multicast and broadcast</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
Thank @superboySB (Dr. Zipeng Dai), @ddherm (Mr. Kai Fang) for their contributions!
